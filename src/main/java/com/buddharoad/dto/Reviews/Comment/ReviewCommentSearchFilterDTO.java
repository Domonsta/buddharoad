// src/main/java/com/buddharoad/dto/Reviews/Comment/ReviewCommentSearchFilterDTO.java
...
@AllArgsConstructor
@Builder
public class ReviewCommentSearchFilterDTO {

    private Long reviewId; // 특정 리뷰의 댓글만 검색할 경우 사용
